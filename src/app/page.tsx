...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-stone-900">
      ...
      >
        <div
          className="h-full bg-gradient-to-r from-amber-500 via-orange-500 to-orange-600 transition-[width] duration-150 ease-out"
      ...
      >
        ...
        <a
          href="#contact"
          className="inline-flex items-center justify-center gap-2 bg-orange-600 py-3.5 text-sm font-semibold text-white hover:bg-orange-700"
        >
